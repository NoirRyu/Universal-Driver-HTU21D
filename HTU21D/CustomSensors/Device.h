...
private:
	...
	//chris for HW specific behavior 
	NTSTATUS                    ConfigureIoTarget(_In_ WDFCMRESLIST ResourceList, _In_ WDFCMRESLIST ResourceListTranslated);
...
//chris 
#define SAMPLE_TEMPERATURE_HOLD  0xE3
#define SAMPLE_HUMIDITY_HOLD     0xE5